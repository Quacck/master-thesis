...
In our case, a small model \webcite{web_distilbertdistilroberta-base_2024} is chosen.
...
NVIDIA provides a guide on how to do so \webcite{web_nvidiapower}.
...
\todo[inline]{Discuss that there is a spike in power at the end?}
\todo[inline]{The Download phase basically returns to the baseline}
...
\todo[inline]{Add the startup experiment}
...
Each of the 10 runs is taken as the ground truth while the other 9 are used to create the model. 
