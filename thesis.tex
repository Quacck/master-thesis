...
\begin{document}
	...
	\include{content/1_introduction} % example
	\include{content/2_background} % example
	\include{content/3_related_work} % example
	\include{content/4_methodology} % example
	\include{content/5_results} % example
	\include{content/6_discussion} % example
	\include{content/7_future_work} % example
