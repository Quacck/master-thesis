...
The huggingface trainer supports callbacks, I thus modified the code by adding timestamped logs. These "Events" would be output into another \verb|.csv| file I could later use.\todo{Later use for WHAT?!}
