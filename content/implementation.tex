...
As of now, the following types are supported: \verb|constant|, \verb|constant-from-stawp|, \verb|stawp|\todo{Use this in the implementation}, and \verb|ml|. 
...
We thus chose the \emph{Gurobi} solver, a commercial solver that also offers academic licenses.\todo{Add cite}
