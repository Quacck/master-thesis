...
\paragraph{The War of the Efficiencies: the Tension between Carbon and Energy Optimization}\cite{hanafy_war_2023} This paper outlines the different ways of carbon-aware computing. 
...
\paragraph{Let's wait awhile: how temporal workload shifting can reduce carbon emissions in the cloud} This paper will be built upon in our work.\todo{Weigh this sentences with the GAIA paper as that is the one I am actually forking from}
...
\todo[inline]{Should write about this :D}