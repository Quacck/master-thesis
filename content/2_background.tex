...
As outlined in the previous chapter, there is a diurnal rhythm to the renewable energy production.\todo{Add something about the "duck curve"}
...
\begin{figure}
    ...
    \caption[short]{Mix of energy production in Germany in 2023 \webcite{web_agora}. Seasonally, renewables will be highest during summer but may also spike during holidays.}
