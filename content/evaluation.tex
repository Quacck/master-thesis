...
As previously discussed in Section \ref{sec:checkpoint_resume_lp}, calculating the suspend \& resume scheduling tends to have high runtime and memory requirements. 
