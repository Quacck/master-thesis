...
The workers in this case are python docker containers that were created with the help SCORE Lab's online knowledge base. \footnote{\url{score.hpi.uni-potsdam.de/docs/Slurm/index.html}}
