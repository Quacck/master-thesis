...
There are multiple implementations in recent literature. Wiesner et al. use a simulation approach to examine temporal shifting\cite{wiesner_lets_2021} via their \emph{WaitAWhile} algorithm. Their workload model consists of known length jobs with constant power, explicitly ruling out resumption costs. 
